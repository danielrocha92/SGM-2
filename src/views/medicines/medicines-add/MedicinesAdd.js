          ...
          <CCard>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="text-input">Substância</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput id="text-input" name="text-input" placeholder="Insira o nome da substância" />
                    <CFormText>Este campo deve ser preenchido</CFormText>
                  </CCol>
                </CFormGroup>
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="text-input">Quantidade Comprada</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput id="number-input" name="number-input" placeholder="Insira a quantidade comprada" />
                    <CFormText>Este campo deve ser preenchido</CFormText>
                  </CCol>
                </CFormGroup>
